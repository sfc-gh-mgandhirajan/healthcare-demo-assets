...
CREATE TABLE IF NOT EXISTS X12_EDI_AI.CLAIMS.LANDING_837_CLAIMS (
    ...
    benefits_assignment_certification VARCHAR(5),
    ...
    billing_provider_address_1      VARCHAR(100),
    billing_provider_address_2      VARCHAR(100),
    billing_provider_city           VARCHAR(50),
    billing_provider_state          VARCHAR(5),
    billing_provider_zip            VARCHAR(20),
