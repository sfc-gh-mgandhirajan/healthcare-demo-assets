...
The IDC corpus Voxel was built and benchmarked on is 100% NATIVE UNCOMPRESSED
...
For every file we record, independently of Voxel, what pydicom itself reports as
...
def build(base_path: Path, uid, n_frames: int, mode: str, out_name: str) -> dict:
    ...
    # ---------------------------------------------------------------------
    # GROUND TRUTH, computed independently of Voxel.
    #
