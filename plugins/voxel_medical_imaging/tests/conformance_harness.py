"""DICOMweb conformance harness -- runs real HTTP against a deployed Voxel service.
...
DICOMweb semantics -- it has no access to Voxel internals and does not import
