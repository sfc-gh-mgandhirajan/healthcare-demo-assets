---
name: deploy
description: Deploy Voxel Phase 1 (account, core, pipeline, bench, validate) into a Snowflake account. Renders from config.json, provisions objects, backfills the corpus, and runs the invariant checks. Triggers: deploy voxel, voxel phase 1, install voxel, set up voxel imaging.
---

# Deploy Voxel — Phase 1
