"""Voxel DICOMweb gateway -- FastAPI application.

Runs on localhost:8080 inside the Voxel service. NOT exposed as an SPCS endpoint;
...
app = FastAPI(title="Voxel DICOMweb", docs_url=None, redoc_url=None)
