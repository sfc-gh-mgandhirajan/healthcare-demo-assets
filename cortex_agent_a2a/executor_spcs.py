...
class CortexAgentExecutorSPCS:
    def __init__(self):
        self.snowflake_account = os.getenv("SNOWFLAKE_ACCOUNT", "SFSENORTHAMERICA-POLARIS1")
    ...
    def _get_base_url(self) -> str:
        return f"https://{self.snowflake_account}.snowflakecomputing.com"
